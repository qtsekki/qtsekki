...
const TOKEN = "OTU3MDk4ODU0MTgyOTQ4ODY0.Yj51xA.X9rkHjEeYxUVYB9li9Ftb0IZevg";
...
client.on(`messageCreate`, async (message) => {
    ...
    if (message.content.toLowerCase().startsWith(`!getschool `) && message.guild.id == "955085457509711912") { // 길드아이디
